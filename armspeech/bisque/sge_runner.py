...
def main(args):
    ...
    try:
        ...
        print 'sge_runner: job', job.name, '(', liveJob.dir, ') started at', datetime.now(), 'on', os.environ['HOSTNAME']
        ...
        print 'sge_runner: job', job.name, '(', liveJob.dir, ') finished at', datetime.now(), 'on', os.environ['HOSTNAME']
    except:
        liveJob.setError()
        raise
